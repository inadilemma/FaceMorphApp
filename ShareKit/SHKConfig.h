...
#define SHKFacebookAppID      @"178778352208628"
 ...
 */
#define SHKTwitterConsumerKey		@"ia46TaisLOibPhJHvqwZYQ"
#define SHKTwitterSecret			@"foaOiDb1Z2V5TsBJkR9689v8VIeSyR2ZEnJlJ8vI"
#define SHKTwitterCallbackUrl		@"http://www.placeholder.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
